...
def bulgeMeanVelocity(dataPath='',showPlot=True,arguments=[]):
    data4 = np.loadtxt(dataPath+'bulgeMeanVelocity-4.dat',delimiter=',')
    data6 = np.loadtxt(dataPath+'bulgeMeanVelocity-6.dat',delimiter=',')
    data8 = np.loadtxt(dataPath+'bulgeMeanVelocity-8.dat',delimiter=',')
    plt.figure()
