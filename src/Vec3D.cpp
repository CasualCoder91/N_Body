...
Vec3D Vec3D::projectPosition(const Vec3D& target, const Vec3D& lookAt, const Vec3D& origin, const double fovAngle) {
...
Vec3D Vec3D::project(Vec3D& position, Vec3D& velocity, Vec3D& lookAt, Vec3D& origin){
	...
	Vec3D position2d = Vec3D(focalLength * positionCam.x / positionCam.z, focalLength * positionCam.y / positionCam.z, 0);
	Vec3D velocity2d = 1 / positionCam.z * velocity + velocity.z / (positionCam.z * positionCam.z) * positionCam;
...
Vec3D Vec3D::projectVelocity(const Vec3D& target, const Vec3D& lookAt, const double fovAngle){
