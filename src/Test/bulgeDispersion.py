...
data4 = np.loadtxt('E:/Master_Thesis/VS_Project/N_Body/src/Test/bulgeDispersion-4.dat',delimiter=',')
data6 = np.loadtxt('E:/Master_Thesis/VS_Project/N_Body/src/Test/bulgeDispersion-6.dat',delimiter=',')
data8 = np.loadtxt('E:/Master_Thesis/VS_Project/N_Body/src/Test/bulgeDispersion-8.dat',delimiter=',')
plt.figure()
