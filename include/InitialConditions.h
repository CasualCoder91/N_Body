...
public:
	...
	*/
	...
	@param [in,out] stars The positions of these stars will be modified.
	@param coneBoundaryMin Point inside the cone closest to the origin.
	@param coneBoundaryMax Point inside the cone farthest away from the origin.
	@param coneR Radius of the cone.
