...
ax.plot(dataDisk[:,0], dataDisk[:,1], label='disk')
ax.plot(dataBlackHole[:,0], dataBlackHole[:,1], label='black hole')
ax.plot(dataBuldge[:,0], dataBuldge[:,1], label='buldge')
ax.plot(dataHalo[:,0], dataHalo[:,1], label='halo')
